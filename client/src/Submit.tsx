...
export class Submit extends Component<SubmitProps, SubmitState> {
    ...
    return <div>
      ...
      <div className="inretaction-container">
        ...
        <div className="result-container">
          ...
          <p dangerouslySetInnerHTML={{ __html: this.state.message === "" ? this.state.currentResult : this.state.message }}></p>
        </div>
      </div>
  ...
  doSubmitJson = (data: unknown): void => {
    ...
    if (data.probability >= AI_PROB_THRESHOLD) {
      this.setState({
        currentResult: `This text is likely to be generated by an AI model\n <br/>Probability AI generated: <span style="color: red; font-size: 24pt;">${(data.probability * 100).toFixed(2)}%</span>`,
        loading: false,
        message: "",
        abortController: null
      });
      ...
      this.setState({
        currentResult: `This text is likely to be generated by a mixture of human and AI text \n <br/>Probability AI generated: <span style="color: yellow; font-size: 24pt;">${(data.probability * 100).toFixed(2)}%</span>`,
        loading: false,
        message: "",
        abortController: null
      });
      ...
      this.setState({
        currentResult: `This text is likely to be written by a human \n <br/>Probability AI generated: <span style="color: green; font-size: 24pt;">${(data.probability * 100).toFixed(2)}%</span>`,
        loading: false,
        message: "",
        abortController: null
      });
